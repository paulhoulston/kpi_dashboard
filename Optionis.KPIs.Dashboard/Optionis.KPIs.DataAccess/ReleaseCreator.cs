...
namespace Optionis.KPIs.DataAccess
{
    ...
    {
        public const string INSERT_RELEASE_SQL = @"INSERT INTO Releases(Application, Comments, Created, CreatedBy, Title) VALUES (@application, @comments, @created, @createdBy, @title); SELECT SCOPE_IDENTITY()";
